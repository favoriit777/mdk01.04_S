# Практическая работа №2 Работа с типами данных и конвертированием в .NET
## Вариант 15:Универсальный преобразователь

Задание: Напишите программу, которая запрашивает у пользователя текст и тип включения ( "int", "double", "bool")
```csharp
using System;
